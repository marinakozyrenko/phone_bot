...
def main(message):
    if message.text == '/main':
        ...
        bot.send_message(message.chat.id, f'{ch.retrive()}')
...
def find_surname(message):
    ...
    bot.send_message(message.chat.id, f'{ch.retrive(surname=surname_it)}')
...
def find_name(message):
    ...
    bot.send_message(message.chat.id, f'{ch.retrive(name=name_it)}')
...
def find_number(message):
    ...
    bot.send_message(message.chat.id, f'{ch.retrive(number=number_it)}')
...
def get_email(message):
    ...
    ch.create(name_it, surname_it, number_it, email_it)
...
def change_new_number(message):
    ...
    ch.update(id=user_id_it, new_number=new_number_it)
    bot.send_message(
